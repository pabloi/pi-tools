function [distPoints,evalPoints] = computeAngleOnSphereQuadDist(sphereDim,Nrepeats,evalPoints)
...
%of a spheric shell of dimension sphereDim
...
for j=1:Nrepeats
    randomSample=abs(randn(2,sphereDim)); %Draw random points in space
    ...
    %symmetricity and getting the abs of it to project into the first
    %quadrant.
